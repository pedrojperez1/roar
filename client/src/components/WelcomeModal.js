...
const WelcomeModal = ({isOpen, onClose, refetch}) => {
  ...
  const welcome = {
    ...
    2: {
      message: "Soon, you will be redirected to your Home page. On your Home page, you can see how you are doing with your exposures and you can navigate to other parts of the app.",
      emoji: "🏠"
    },
    3: {
    ...
    4: {
      message: "The Following tab shows you a list of other users you are following. This is a good place to find and connect with other users on the site that are tackling similar fears.",
      emoji: "👋"
    },
    5: {
  ...
  return (
    <Modal isOpen={isOpen} onClose={closeModal}>
      ...
      <ModalContent>
          ...
          <ModalFooter>
            <HStack>
              <Text>{step} / {Object.keys(welcome).length}</Text>
              <Spacer />
              <Button 
                colorScheme="purple" 
                onClick={handleNext}
