    ...
    <div className="NewLadderStep2">
      <Container maxW="xl">
        <Fade in={true}>
          <Stack>
            <Text fontSize="xl">
              What is the one activity that you would like to be able to do but cannot because of
              this fear?
            </Text>
            <Text fontSize="xl">
              For example, if my fear was dogs and I really wanted to be able to walk by the dog
              park, I would write: <i>Walk by the dog park</i>.
            </Text>
            <Text fontSize="xl">
              We will call this your <b>Summit</b>. At the end of this journey, we all want to reach
              the summit!
            </Text>
            <FormControl>
              <Input
          ...
          <Flex mt={8}>
            <Button variant="outline" colorScheme="purple" onClick={() => setStep(1)}>
              Back
            </Button>
            <Spacer />
            {summit.length > 4 && (
