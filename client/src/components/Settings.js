            ...
            <Flex width="full" justifyContent="center">
                <Box p={8} maxWidth="500px" borderWidth={1} borderRadius={8} boxShadow="lg">
                    <Heading>
                        <Stack>
                            <Box textAlign="right">
                                <Button variant="ghost" colorScheme="purple" size="xs" onClick={onOpen}>Edit Avatar</Button>
                            </Box>
                            <Center>
                                <Image 
                                    borderRadius="full"
                                ...
                                <Stack spacing={4}>
                                    <Field name="isPublic">
                                        {({ field, form }) => (
                                            <FormControl display="flex" alignItems="center">
                                                <HStack spacing={3}>
                                                    <Switch {...field} id="isPublic" size="lg" colorScheme="purple" isChecked={form.values.isPublic}/>
                                    ...
                                    <Field name="emailNotif">
                                        {({ field, form }) => (
                                            <FormControl display="flex" alignItems="center">
                                                <HStack spacing={3}>
                                                    <Switch {...field} id="emailNotif" size="lg" colorScheme="purple" isChecked={form.values.emailNotif}/>
                                        ...
                                        <Field name="email" validate={validateEmail}>
                                            {({field, form}) => (
                                                <FormControl isInvalid={form.errors.email && form.touched.email}>
                                                    <Input {...field} id="email" variant="flushed" placeholder="Email address" />
