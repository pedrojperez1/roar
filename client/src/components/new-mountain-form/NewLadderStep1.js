      ...
      <Container maxW="xl">
        <Fade in={true}>
          <Stack spacing={3}>
            ...
            <Text fontSize="xl">
              It can be as fun or as boring as you want, but it should be related to the fear you
              want to conquer.
            </Text>
            <Text fontSize="xl">
              For example, if I want to work on my fear of dogs, I might write:{" "}
          ...
          <Flex mt={8}>
            <Button colorScheme="purple" variant="outline" onClick={() => setStep(0)}>
              Back
            </Button>
            <Spacer />
            {ladderName.length > 4 && (
